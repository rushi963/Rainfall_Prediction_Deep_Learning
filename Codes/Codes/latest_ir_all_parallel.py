    ...
    if filepath.endswith(".h5"):
        ...
        if 4 < int(time_crop) < 19:
            ...
            for i in index:
                ...
                dataset[count][14] = vegetation[count]
                count = count + 1
            ...
            print(day, time_crop)
            out_path = '/media/geospacial2/Data/Out/June_2014/' + '%s/' % d[0:2]
...
path = '/media/geospacial2/Data/IR/June_2014'
#path = '/home/geospacial2/Desktop'
num_cores = multiprocessing.cpu_count()
for subdir, dirs, files in os.walk(path):
    Parallel(n_jobs=num_cores-1)(delayed(ir)(file) for file in files)
